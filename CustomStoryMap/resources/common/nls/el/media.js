define(
	 ({
		commonMedia: {
			...
			videoSelectorOther: {
				explain1: "Η αφήγηση δεν έχει δυνατότητα αναπαραγωγής μη επεξεργασμένων βίντεο (π.χ. avi, mpeg), αλλά μπορεί να αναπαράγει φιλοξενούμενα αρχεία βίντεο που έχουν ενσωματωμένα προγράμματα αναπαραγωγής (π.χ. YouTube ή Vimeo).",
